...
def menu_principal(vista):
    ...
    barra_titulo = Label(vista.frame_ab, text="Analizador de Impacto Ambiental", background="#46dab7", foreground="black", font=("Arial", 14, "bold"))
    ...
    boton_m = Button(vista.frame_ab, text="Modificar", command = lambda: vista.funcion_modificar)
    boton_m.grid(row=1, column=8, sticky="ew", padx=2)
    boton_c = Button(vista.frame_ab, text="Consultar", command = lambda: vista.funcion_consultar)
